...
class EditTaskCommand extends CommandBase {
	...
	protected function getOptions()
	{
		return array_merge(parent::getOptions(),array(
			array('descript', 'd', InputOption::VALUE_REQUIRED, 'New description for task.'),
			array('action', 'a', InputOption::VALUE_REQUIRED, 'Is task a next action (yes|no).')
		));
	}
