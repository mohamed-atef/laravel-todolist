...
class TodoListTest extends TestCase
{
	...
	/**
	 * @expectedException RuntimeException
	 * @expectedExceptionMessage Repository couldn't save
	 */
	...
	/**
	 * [testArchiveWithNoIdThrowsException]
	 * @expectedException RuntimeException
	 * @expectedExceptionMessage Cannot archived if id not set
	 */
	...
	/**
	 * [testArchiveWhenRepoFailsOnDelete]
	 * @expectedException RuntimeException
